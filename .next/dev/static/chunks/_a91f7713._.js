...
function AdminDashboard() {
    ...
    const [topMedicines, setTopMedicines] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        {
    ...
    const [salesTrend, setSalesTrend] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        {
            sale_day: '2024-12-14',
            transactions: 23,
            revenue: 4200,
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false) // Set to false to show static data immediately
    ;
    ...
    const [expiryData, setExpiryData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        {
            name: "Active",
            value: 224,
            color: "#10B981"
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDashboard.useEffect": ()=>{
                    ...
                    try {
                        ...
                        if (totalCount && totalCount > 0) {
                            ...
                            const totalStock = medicines?.reduce({
                                "AdminDashboard.useEffect.fetchStats": (sum, m)=>sum + (m.quantity || 0)
                            }["AdminDashboard.useEffect.fetchStats"], 0) || 0;
                            ...
                            if (salesStatsData.success && salesStatsData.data) {
                                ...
                                if (trend && trend.length > 0) {
                                    const chartData = trend.slice(-7).map({
                                        "AdminDashboard.useEffect.fetchStats.chartData": (day)=>({
                                    ...
                                    }["AdminDashboard.useEffect.fetchStats.chartData"]);
                            ...
                            allMedicines?.forEach({
                                "AdminDashboard.useEffect.fetchStats": (med)=>{
                                    const cat = med.category || "Other";
                                    categoryMap.set(cat, (categoryMap.get(cat) || 0) + (med.quantity || 0));
                                }
                            }["AdminDashboard.useEffect.fetchStats"]);
                            setCategoryData(Array.from(categoryMap.entries()).map({
                                "AdminDashboard.useEffect.fetchStats": ([category, stock])=>({
                                        category,
                                        stock
                                    })
                            }["AdminDashboard.useEffect.fetchStats"]).slice(0, 6));
                            // Calculate expiry distribution
                            const now = new Date();
                            const expired = allMedicines?.filter({
                                "AdminDashboard.useEffect.fetchStats": (m)=>new Date(m.expiry_date || "") < now
                            }["AdminDashboard.useEffect.fetchStats"]).length || 0;
                            const expiringSoon = allMedicines?.filter({
                                "AdminDashboard.useEffect.fetchStats": (m)=>{
            ...
            const medicinesChannel = supabase.channel("medicines-changes").on("postgres_changes", {
                ...
                "AdminDashboard.useEffect.medicinesChannel": ()=>{
                    fetchStats();
                }
            }["AdminDashboard.useEffect.medicinesChannel"]).subscribe();
            const salesChannel = supabase.channel("sales-changes").on("postgres_changes", {
                event: "*",
                schema: "public",
                table: "sales"
            }, {
                "AdminDashboard.useEffect.salesChannel": ()=>{
                    fetchStats();
                }
            }["AdminDashboard.useEffect.salesChannel"]).subscribe();
            // Poll for updates every 30 seconds
            const pollInterval = setInterval({
                "AdminDashboard.useEffect.pollInterval": ()=>{
                    fetchStats();
                }
            }["AdminDashboard.useEffect.pollInterval"], 30000);
            return ({
                "AdminDashboard.useEffect": ()=>{
...
_s(AdminDashboard, "D/B7UWN8M4/PioqcZ4SFA7typ6M=");
_c = AdminDashboard;
...
//# sourceMappingURL=_a91f7713._.js.map