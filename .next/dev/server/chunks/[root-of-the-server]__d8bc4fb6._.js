...
async function updateSession(request) {
    ...
    if ((request.nextUrl.pathname.startsWith("/admin") || request.nextUrl.pathname.startsWith("/manager")) && !user) {
