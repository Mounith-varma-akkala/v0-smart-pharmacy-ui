...
"[project]/app/api/analytics/sales-heatmap/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const { data: salesData, error } = await supabase.from('sales').select('created_at, quantity').gte('created_at', thirtyDaysAgo.toISOString());
        ...
        salesData?.forEach((sale)=>{
            ...
            const dataPoint = heatmapData.find((d)=>d.day === days[dayOfWeek] && d.hour === hour);
            if (dataPoint) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'Failed to generate sales heatmap'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d6a38e7a._.js.map