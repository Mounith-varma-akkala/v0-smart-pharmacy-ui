    ...
    try {
      ...
      `).order('name');
        ...
        const processedSuppliers = suppliers?.map((supplier)=>({
                ...
                medicines_supplied: supplier.supplier_medicines?.map((sm)=>sm.medicine_name) || [],
                ...
                on_time_delivery_rate: supplier.supplier_orders?.length > 0 ? Math.round(supplier.supplier_orders.filter((order)=>order.delivered_on_time).length / supplier.supplier_orders.length * 100) : 0,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2105b2d4._.js.map